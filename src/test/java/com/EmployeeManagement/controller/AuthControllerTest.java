...
class AuthControllerTest {
    ...
    void saveUserSuccessTest() throws Exception{
        var request=new UserRequest("Ramin","Rov","ramin@gmail.com","ra1000","12345", Set.of(RoleDto.builder().id(1).build()));
        var response=new UserResponse(7,"Ramin","Rov","ramin@gmail.com","ra1000","12345", Set.of(RoleDto.builder().id(1).build()));
    ...
    void getAllPositionsSuccessTest() throws Exception{
        var response1=new UserResponse(7,"Ramin","Rov","ramin@gmail.com","ra1000","12345", Set.of(RoleDto.builder().id(1).build()));
        var response2=new UserResponse(7,"Akif","Tov","akif@gmail.com","akif777","12345", Set.of(RoleDto.builder().id(2).build()));
    ...
    void updateUserSuccessTest() throws Exception{
        ...
        int id=7;
        var request=new UserRequest("Ramin","Rov","ramin@gmail.com","ra1000","12345", Set.of(RoleDto.builder().id(1).build()));
        var response=new UserResponse(7,"Ramil","Rov","ramin@gmail.com","Ra1000","12345", Set.of(RoleDto.builder().id(1).build()));
